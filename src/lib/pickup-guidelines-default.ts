/** Default markdown seeded on first deploy; staff can edit in admin. */
export const DEFAULT_PICKUP_GUIDELINES_TITLE =
  "Weekly Green Waste & Cactus Pickup Guidelines";

export const DEFAULT_PICKUP_GUIDELINES_BODY = `## Pickup Schedules
...
Maintenance does not pick up regular trash. Residents are responsible for bringing their own trash to the dumpsters, unless a special pickup has been explicitly scheduled with the office.
`;
