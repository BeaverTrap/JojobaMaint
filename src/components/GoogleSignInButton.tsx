  ...
  return (
    <div className="w-full">
      <button
        onClick={signIn}
        disabled={loading}
        className="flex w-full items-center justify-center gap-3 rounded-xl border border-line bg-surface px-4 py-3 text-sm font-semibold text-ink shadow-sm transition hover:bg-hover disabled:cursor-not-allowed disabled:opacity-60"
      >
        <GoogleIcon />
