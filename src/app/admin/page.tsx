  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-line bg-surface p-5 shadow-sm">
        <h2 className="text-sm font-semibold text-ink">Maintenance assessments</h2>
        <p className="mt-1 text-sm text-muted">
          Pipes, halls, big projects, landscaping (lift week, rentals),
          cross-connection, pond work, and more — publish for transparency.
        </p>
        <Link
        ...
        >
          Manage maintenance assessments →
        </Link>
      </div>

      <div className="rounded-2xl border border-line bg-surface p-5 shadow-sm">
        <h2 className="text-sm font-semibold text-ink">Tree assessments</h2>
        <p className="mt-1 text-sm text-muted">
          Lot-specific tree and plant evaluations — damage, resident inquiries,
          and findings. Publish for transparency.
        </p>
        <Link
